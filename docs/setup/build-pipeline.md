...
После этого React-приложение использует сгенерированную библиотеку.
...
В отличие от режима разработки здесь можно проверить работу Service Worker и offline-first.
