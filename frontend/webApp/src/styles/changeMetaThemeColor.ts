...
// };
//
// const easeFun = (t: number): number => t;
//
// export function changeMetaThemeColor(
//     element: HTMLElement | undefined,
//     targetColor: string,
...
//
//
//         if (isStandalone) { // если PWA
//             // смена metaTag – дорогая операция – попытка оптимизировать
//             const step = Math.floor(progress * 15); // 15 обновлений 0_0
//             if (step !== lastThemeUpdateStep || progress === 1 || progress === 0) {
//                 metaTag!.content = rgbStr;
//                 lastThemeUpdateStep = step;
//             }
//         } else {
//             metaTag!.content = rgbStr;
//         }
