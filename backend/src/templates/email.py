    ...
    def get_verification_template() -> str:
        ...
        <body style="margin: 0; padding: 0; font-family: 'Inter', Helvetica, Arial, sans-serif; background-color: #ffffff;">
            <div style="max-width: 400px; margin: 0 auto; padding: 40px 20px; text-align: center;">
                ...
                <p style="color: #999999; font-size: 12px;">Код действителен в течение """ + f"{settings.email_code_expire_min}" """  минут. Если вы не запрашивали его, просто проигнорируйте это письмо.</p>
            </div>
        </body>
        </html>
        """
